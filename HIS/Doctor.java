...
public class Doctor extends JFrame{
	...
	JLabel ID = new JLabel("Enter Doctor ID: ");
	JLabel SPC = new JLabel("Enter Specialization: ");
	...
	public void prefaceD(){
		frm.repaint();
		frm.validate();
		frm.setIconImage(image.getImage());
		frm.setSize(450,200);
		frm.setLocationRelativeTo(null);
		frm.setTitle("TH: Doctors");
	...
	class ActionButton1 implements ActionListener{
		public void actionPerformed(ActionEvent e){
			if(e.getSource()==add){
				...
				frm2.setTitle("Add to Docotor's Records");
				...
				frm2.setSize(500,500);
				frm2.setLocationRelativeTo(null);
				frm2.setTitle("Remove from Docotor's Records");
				frm2.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
